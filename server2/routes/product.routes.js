...
import ProductReviews from "../models/users.js";
import Product from "../models/product.js";
import getRecommendedProductsCollaborative from "../utils/getRecommendedProductsCollaborative.js";
...
router.get('/homepage', async (req, res) => {
    try {
        ...
        const topSelling = await Product.find({ 
            // is_popular: true, 
            salesCount: { $gte: thresholds.topSellers }, // Apply popularity score threshold
            price: { $gte: minPrice || 0, $lte: maxPrice || Number.MAX_VALUE } 
        })
            .sort({ salesCount: -1 }) // Sort most popular by popularity score
            .lean()
            .limit(limit);
        ...
        const combinedProducts = [
            ...
            {products: topSelling, category: 'topSelling'},
            {products: featured, category: 'featured'},
