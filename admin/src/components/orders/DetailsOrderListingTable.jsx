...
const DetailsOrderListingTable = ({orders}) => {
	...
	// 	fetchDataFromApi(`/api/order/sub/${orderId}`).then((res) => {
	// 		setSubOrderorder(res.order[0]);
...
export default DetailsOrderListingTable;