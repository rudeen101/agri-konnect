...
const SalesDetails = () => {
    ...
    const handleTrackingChange = (orderStatus) => {
        let status = orderStatus.toLowerCase()
        updateDataToApi(`/api/order/tracking`, {status}).then((res) => {
            fetchOrder()
        });
    }
            ...
            <div className="rightContent w-100">
                ...
                <div className="orderInfoContainer d-flex mt-5">
                    <div className="card shadow border-0 p-3 orderInfo">
                        <h3 className="hd">Sales Details</h3>
                        ...
                        <div className="orderDetailsList orderInfo">
                            ...
                            <li style={{textTransform: "capitalize"}}>Vendor/Customer: <span>{order?.orderedBy?.name}</span></li>
                        </div>
                    </div>
                    ...
                    <h2 className="hd">Orders Listing</h2>
                        {/* <table className="table table-striped table-bordered">
                            ...
                            <tbody>
                            {
                                ...
                                subOrder?.orderItems?.map((order, index) => {
                                    return (
                                        <tr key={index}>
                                            <td >
                                                <div className="imageContainer card">
                                                    <Link to={`/order/details/${order?.order}`}>
                                                        <img src={order.images[0]} alt="order image" className="w-100"/>
                                                    </Link>
                                                </div>
                                            ...
                                            <td>
                                                <div className="actions d-flex align-items-center">
                                                    <StyledSelect onSelectChange={handleStatusChange} orderId={order?._id} selectorder={statusList} orderId={order?.order}></StyledSelect>
                                                </div>
                                            </td>
                                        </tr>
                                    )
