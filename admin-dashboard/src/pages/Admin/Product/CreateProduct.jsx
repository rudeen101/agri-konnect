...
const AddProductDashboard = () => {
  ...
  //       isPrimary: previewImages.length === 0 && files.indexOf(file) === 0
  //     }));
  ...
  const handleSubmit = async(e) => {
    ...
    const response = await postDataToApi(`/api/v1/product`, finalFormData)

    if (response.success) {
      // Show success message
      context.showNotification(`Product created successfully!`, 'success');
      ...
      context.showNotification(`Couldn't create product, try again!`, 'error');
