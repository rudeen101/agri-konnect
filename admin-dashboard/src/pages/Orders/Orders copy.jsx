...
const Orders = () => {
    ...
    useEffect(() => {
        const handleClickOutside = (event) => {
            ...
            if (updateModalOpen && updateModalRef.current && !updateModalRef.current.contains(event.target)) {
    ...
    }, [activeMenuId, sidebarOpen, deleteModalOpen, updateModalOpen]);
    ...
    //     {console.log("testig order", order)}
    //     const searchTermLower = searchTerm.toLowerCase();
        
    //     return (
    //         order.user.name.toLowerCase().includes(searchTermLower) ||
    //         order.user.fullName.toLowerCase().includes(searchTermLower) ||
    ...
    //         order.shippingAddress.county.toLowerCase().includes(searchTermLower) ||
    //         (order.paymentDetails.phoneNumber && order.paymentDetails.phoneNumber.includes(searchTerm)) ||
    ...
    console.log("testing", filteredOrders)

    const currentOrder = currentOrderId ? orders[currentOrderId] : null;
    const orderToDelete = orderToDeleteId ? orders[orderToDeleteId] : null;
        ...
        <div className="container">
            ...
            <div className="main-content">
                ...
                <div className="dashboard-section">
                        ...
                        <div className="table-container">
                            ...
                            <div className="desktop-table">
                                <table>
                                    ...
                                    <tbody>
                                    {filteredOrders?.length > 0 && filteredOrders?.map(([id, order]) => (
                                            <tr key={id}>
                                    ...
                                    <div className="user-card" key={`mobile-${id}`}>
                                        <div className="card-header">
                                            ...
                                            <div className="user-info">
                                                ...
                                                <div>
                                                    <div className="user-name">{order?.id}</div>
                                                </div>
                                            </div>
                                            <button 
                                                className="action-btn" 
                                            ...
                                            >
                                                ...
                                                <Link to={`/admin/update-product/${order?.id}`}>
                                        ...
                                        <div className="card-details">
                                            ...
                                            <div className="detail-row">
                                                ...
                                                <span className="detail-value">{order?.isPaid ? "Paid" : "Pending"}</span>
                                            </div>
                                            <div className="detail-row">
                                            ...
                                            {/* {
                                                orders.length > 0 && orders.map((item) => (
                                                    <div className='product-item'>
                                                        <img src={item.image} alt={item.name} className="product-image-sm"/>
                    ...
                    {/* Status Update Modal */}
                    <div className={`modal-overlay ${updateModalOpen ? 'active' : ''}`}>
                        <div className="modal">
                            <div className="modal-header">
                            ...
                            <div className="modal-body">
                                <p className="modal-message">
                                    Select the new status for order <strong>#ORD-1001</strong>
                                </p>
